...
/* compress 1024-bits */
__device__ int sha512_compress(sha512_context *md, unsigned char *buf) {
...
/**
   ...
   @return 0 if successful
*/
__device__ int sha512_update(sha512_context *md, const unsigned char *in,
                             size_t inlen) {
  size_t n;
  size_t i;
  int err;
...
__device__ int sha512(const unsigned char *message, size_t message_len,
           unsigned char *out) {
  sha512_context ctx;
  int ret;
